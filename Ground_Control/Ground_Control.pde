...
// ==========================================
// 3D MODEL VIEWPORT (UPDATED ROTATION ORDER)
// ==========================================
void drawCenter3DModelSpace() {
  ...
  // --- FIXED TRANSFORMATION ORDER (Option 2: Roll -> Pitch -> Yaw) ---
...
// ==========================================
// RIGHT PANEL COMMAND LAYOUTS & RAW RX TEXT
// ==========================================
